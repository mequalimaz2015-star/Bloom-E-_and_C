        ...
        <div class="nav-links">
            ...
            <div class="nav-dropdown" id="nd-home">
                ...
                <div class="nav-dropdown-panel">
                    ...
                    <a href="index.php"><span class="nd-item-icon"><i class="fa-solid fa-images"></i></span>Home
                        Carousel</a>
                    <a href="home_image.php"><span class="nd-item-icon"><i class="fa-regular fa-image"></i></span>Home
                        Image</a>
                    <a href="home_video.php"><span class="nd-item-icon"><i class="fa-solid fa-video"></i></span>Home
                        Video</a>
            ...
            <div class="nav-dropdown" id="nd-about">
                ...
                <div class="nav-dropdown-panel">
                    ...
                    <a href="#ceo-message"><span class="nd-item-icon"><i class="fa-solid fa-user-tie"></i></span>Message
                        from CEO</a>
                    <a href="#history"><span class="nd-item-icon"><i class="fa-solid fa-timeline"></i></span>Our
                        History</a>
                    <a href="#team"><span class="nd-item-icon"><i class="fa-solid fa-users"></i></span>Our Team</a>
                </div>
            </div>
            ...
            <div class="nav-dropdown" id="nd-services">
                ...
                <div class="nav-dropdown-panel">
                    ...
                    <a href="#services" onclick="filterServices('all'); closeAllNavDropdowns();"><span
                            class="nd-item-icon"><i class="fa-solid fa-border-all"></i></span>All Services</a>
                    <?php if (!empty($service_categories)): ?>
                        <?php foreach ($service_categories as $cat): ?>
                            <a href="#services"
                                onclick="filterServices('<?= htmlspecialchars($cat) ?>'); closeAllNavDropdowns();"><span
                                    class="nd-item-icon"><i class="fa-solid fa-tag"></i></span><?= htmlspecialchars($cat) ?></a>
                        <?php endforeach; ?>
                    <?php else: ?>
    ...
    <header class="hero" id="home">
        <div class="hero-video-container">
            <video id="bgVideo" autoplay muted loop playsinline>
                <source src="<?= htmlspecialchars($company['hero_video'] ?: 'assets/videos/home-video1.mp4') ?>"
                    type="video/mp4">
                <!-- Fallback to external source if local file is unavailable -->
                <source
                    src="https://assets.mixkit.co/videos/preview/mixkit-chef-preparing-a-dish-in-a-professional-kitchen-44445-large.mp4"
                    type="video/mp4">
            </video>
            <?php if (!empty($company['hero_audio'])): ?>
                <audio id="bgAudio" loop preload="auto">
                    <source src="<?= htmlspecialchars($company['hero_audio']) ?>" type="audio/mpeg">
                    <source src="<?= htmlspecialchars($company['hero_audio']) ?>" type="audio/wav">
                    <source src="<?= htmlspecialchars($company['hero_audio']) ?>" type="audio/ogg">
                </audio>
            <?php endif; ?>
            <div class="hero-overlay"></div>

            <!-- Sound Control Button -->
            <button id="soundToggleBtn" onclick="toggleHeroSound()"
                style="position: absolute; bottom: 40px; right: 40px; z-index: 10; background: rgba(0,0,0,0.5); color: #fff; border: 1px solid var(--primary); border-radius: 50%; width: 50px; height: 50px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 20px; transition: 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.3);"
                title="Toggle Sound">
                    ...
                    if (isSoundOn) {
                        if (audio) {
                            ...
                            if (playPromise !== undefined) {
                                playPromise.catch(e => console.log('Audio playback blocked'));
                            }
                            video.muted = true;
                        } else {
                            video.muted = false;
