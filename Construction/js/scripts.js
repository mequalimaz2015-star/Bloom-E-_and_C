...
if (contactForm) {
    contactForm.addEventListener("submit", (e) => {
        // We let the form submit to PHP. 
        // If we wanted JS validation, we would only preventDefault if validation fails.
        // For now, let's just let it submit so the PHP handler can work.
    });
}
