...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_quote'])) {
    ...
    if ($stmt->execute($data)) {
        header("Location: index-video.php?quote_success=1#sec-5");
        exit;
    } else {
...
<body>
    ...
    <section id="sec-0">
        <div class="video-container">
            <video autoplay muted loop playsinline id="heroVideo">
                <source
                    src="<?= !empty($c['hero_video']) ? '../' . $c['hero_video'] : 'https://www.w3schools.com/howto/rain.mp4' ?>"
                    type="video/mp4">
            </video>
            <div class="video-overlay"></div>
            <!-- Sound Control Button -->
            <button id="soundToggleBtn" onclick="toggleHeroSound()"
                style="position: absolute; bottom: 40px; right: 40px; z-index: 10; background: rgba(0,0,0,0.5); color: #fff; border: 1px solid #f39c12; border-radius: 50%; width: 50px; height: 50px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 20px; transition: 0.3s; box-shadow: 0 4px 15px rgba(0,0,0,0.3);"
                title="Toggle Sound">
        ...
        <article>
            <div class="container">
                <h1>
                    <?= htmlspecialchars($c['hero_title'] ?? 'We are Certified Engineers') ?>
                </h1>
                <h2>
                    <?= !empty($c['hero_subtitle']) ? $c['hero_subtitle'] : 'Construction services<br><span>Creative AND professional</span>' ?>
                </h2>
                <p>
    ...
    <section id="sec-2">
        <div class="container">
            <h1 class="wow animated fadeInUp">
                <?= htmlspecialchars($c['why_choose_us_title'] ?? 'WHY CHOOSE US?') ?>
            </h1>
    ...
    <section id="sec-3">
        <div class="container">
            <h1 class="wow animated fadeInUp">
                <?= htmlspecialchars($c['services_title'] ?? 'OUR SERVICES') ?>
            </h1>
            <p class="wow animated fadeInUp" data-wow-delay="0.2s"
    ...
    <section id="sec-4">
        <div class="container">
            <h1 class="wow animated fadeInUp">
                <?= htmlspecialchars($c['projects_title'] ?? 'OUR LATEST PROJECTS') ?>
            </h1>
                            ...
                            <div class="project-inner">
                                <div class="project-img-container">
                                    ...
                                    <div class="project-badge">
                                        <?= htmlspecialchars($p['status'] ?? 'Construction') ?>
                                    </div>
                                </div>
                                <div class="project-info">
                                    ...
                                    <p>
                                        <?= htmlspecialchars(substr($p['description'] ?? 'High-quality engineering project delivered with precision and expertise.', 0, 95)) ?>...
                                    </p>
    ...
    <section id="sec-5">
        <div class="container">
            <h1>
                <?= htmlspecialchars($c['reviews_title'] ?? 'CUSTOMER HIGHLIGHTS') ?>
            </h1>
            <p>
                <?= htmlspecialchars($c['reviews_subtitle'] ?? 'What our clients say about our commitment to excellence.') ?>
            </p>
            <div class="cont"
                    ...
                    <article class="quoteblock wow animated fadeInUp"
                        ...
                        <figure style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                            ...
                            <figcaption style="margin-top: 10px;">
                                <strong style="display: block; color: #333; font-size: 14px;">
        ...
        <div class="contactUs">
            <div class="container">
                <aside>
                    <h1>
                        <?= htmlspecialchars($c['quote_title'] ?? 'Request a Professional Quote') ?>
                    </h1>
                    <h2>
                        <?= htmlspecialchars($c['quote_subtitle'] ?? 'Get an estimate for your project today!') ?>
                    </h2>
                    <?php if ($form_msg): ?>
