...
<body>
    ...
    <!-- Admin Link -->
    <a href="admin.php" style="position: fixed; bottom: 20px; left: 50%; transform: translateX(-50%); z-index: 100; color: rgba(255,255,255,0.3); text-decoration: none; font-size: 11px; letter-spacing: 2px; font-weight: 700; transition: color 0.3s; text-transform: uppercase; padding: 5px 15px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.2); pointer-events: auto;" 
       onmouseover="this.style.color='#f39c12'; this.style.borderColor='rgba(243, 156, 18, 0.4)';" 
